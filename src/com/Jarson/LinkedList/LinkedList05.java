  ...
  新增节点插入方法add（）
        思路：
            ...
            4. 新的节点 （newNode）.next（.privous）指向temp4（frontNode）
                。。。。。以此类推
  最后一步，整理整体的代码，封装代码，能修改的可以修。增加泛型E
 */
public class LinkedList05<E> {
   ...
   public E get(int index){
       ...
       temp2 = getNode(index);
       return temp2 != null ? (E) temp2.element : null;

   }
   private boolean checkRange(int index){
       //做判断
       if(index<0||index>size-1){   //true
   ...
   private Node getNode(int index){
    ...
    public static void main(String[] args){
        LinkedList05 linkedList01 = new LinkedList05();
            linkedList01.add("a");
            linkedList01.add("b");
            linkedList01.add("c");
            linkedList01.add("d");
        ...
        System.out.println(linkedList01.get(4));
